...
public class ChipsAdapter extends BaseAdapter implements Filterable {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Log.i(TAG, items.get(position).getTitle() +  " = " + items.get(position).getImageid());
		vh.img.setImageResource(items.get(position).getImageid());
		vh.tv.setText(items.get(position).getTitle());
